...
public class EmployeeModel {
    ...
    public EmployeeModel(String emp_code,String emp_name,String emp_secret_code,String emp_register_mode,boolean attendance)
    {
    ...
    public void putAttendance(boolean attendance) {
         this.attendance = attendance;
    }
}
